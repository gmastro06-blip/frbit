...
try:
    ...
    print("win32gui not available - cannot detect window coordinates")
    print("\nAlternatively, you can provide coordinates manually:")
    print("  X, Y: Top-left corner of Tibia window")
    print("  Width, Height: Size of Tibia window")
    print("\nExample: If Tibia window is at (100, 50) and size 1200x900:")
    print("  x=100, y=50, width=1200, height=900")